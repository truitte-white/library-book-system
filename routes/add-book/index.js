...
router.get('/edit-book', loggedInMiddleware.loggedIn, authMiddleware.auth, bookController.editBookForm);
...
router.post('/edit-book/:book_id', loggedInMiddleware.loggedIn, authMiddleware.auth, bookController.editBook);
